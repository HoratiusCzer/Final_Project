      ...
      <section id="header">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/product/p1/6.webp" width="100%" id="MainImg" alt="">
               
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/product/p1/6.webp" width="100%" class="small-img" alt="">
                    </div>
                   
                    <div class="small-img-col">
                        <img src="img/sproduct/p3/1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="img/sproduct/p3/2.webp" width="100%" class="small-img" alt="">
                    </div>
            ...
            <form action="manage_cart.php" method="POST">
                   <h4>GINGER NETTLE KOMBUCHA</h4>
                    ...
                    <input type="hidden" name="Item_Name" value="GINGER NETTLE KOMBUCHA">
                    <input type="hidden" name="Price" value="16">

            </form>
                <h4>Product Details</h4>
                <span>
                    Perfect for a hot summer day this kombucha is a 
                    blend of white tea, ginger, and stinging nettle. 
                    This combination is naturally rich in antioxidants and 
                    anti-inflammatory properties. It can boost your immune 
                    system, calm the stomach, relieve allergy symptoms, and 
                    benefit the skin, hair, and bones.
        ...
        <section id="product1" class="section-p1">
            <h2>ELEMENT KOMBUCHA</h2>
            <p><b>Summer's Vibe Collections</b></p>
            <div class="pro-container">
              <div class="pro" onclick="window.location.href='sproducts.html';">
                  <img src="img/product/p1/3.webp">
                  <div class="des">
                      <span>Element</span>
                      <h5>LAVENDER SPEARMINT KOMBUCHA</h5>
                      <div class="star">
