      ...
      <section id="header">
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/product/p1/5.webp" width="100%" id="MainImg" alt="">
               
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/product/p1/5.webp" width="100%" class="small-img" alt="">
                    </div>
                   
                    <div class="small-img-col">
                        <img src="img/sproduct/p2/1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="img/sproduct/p2/2.webp" width="100%" class="small-img" alt="">
                    </div>
                ...
                <form action="manage_cart.php" method="POST">
                   <h4>SUMMER VIBES KOMBUCHA</h4>
                    ...
                    <input type="hidden" name="Item_Name" value="SUMMER VIBES KOMBUCHA">
                    <input type="hidden" name="Price" value="17">
               </form>
                    <h4>Product Details</h4>
                    <span>
                        This kombucha is brewed with an herbal blend that 
                        is focused on balancing the body’s inflammatory
                        response to help keep you comfortable during the
                        allergy season. Whether you have allergies or not
                        this will help build the strength your body needs to respond.
